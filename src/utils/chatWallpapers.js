...
const parseSvgGradient = (gradientStr) => {
...
export const bubblegumSvg = (strokeColor, opacity) => {
...
export const cyberpunkSvg = (strokeColor, opacity) => {
  const { stroke, defs } = processStroke(strokeColor);
...
export const dollhouseSvg = (strokeColor, opacity) => {
  const { stroke, defs } = processStroke(strokeColor);
...
export const builderSvg = (strokeColor, opacity) => {
  const { stroke, defs } = processStroke(strokeColor);
...
export const classicSvg = (strokeColor, opacity) => {
  const { stroke, defs } = processStroke(strokeColor);
...
export const darkyellowSvg = (strokeColor, opacity) => {
  const { stroke, defs } = processStroke(strokeColor);
...
export const sketchbookSvg = (strokeColor, opacity) => {
  const { stroke, defs } = processStroke(strokeColor);
